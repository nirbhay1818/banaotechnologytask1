        ...
        <div>
            ...
            <div className='topbar'>
                ...
                <div style={{width: '360px', paddingTop: '15px', paddingBottom: '15px'}} class="input-group flex-nowrap">
                    <span style={{borderBottomLeftRadius: '21px', borderTopLeftRadius: '21px', backgroundColor: '#F2F2F2', border: 'none'}} class="input-group-text"    id="addon-wrapping"><img alt='search' src={searchicon}/>
                    </span>
                ...
                <div style={{marginRight: '3%', width: '200px', paddingTop: '15px', paddingBottom: '15px'}} class="btn-group">
                    ...
                    {user_signed_in ? 
                        <>
                            <button class="btn btn-sm border-0" type="button" style={{textAlign: 'right'}}>
                                <div style={{display: 'flex'}}>
                                    <img style={{marginTop: '-4px', width: '40px', height: '40px'}} src={u2} alt='profile pic'/>&nbsp;&nbsp;<p style={{marginTop: '5px'}}>Sarah West</p>
                                </div>
                            </button>

                            <button disabled type="button" class="btn btn-sm dropdown-toggle dropdown-toggle-split border-0" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div style={{backgroundColor: 'black'}}>
                ...
                <img src={android} alt="androidimg" style={{width:'100%',position:'relative',height:'40px'}}/>

                <img alt='banner' src={banner} style={{width: '100%', height: (breaking_point_desktop ? '440px' : (breaking_point_mobile ? '300px' : '200px')), opacity: '0.5'}}/>

                <h2 className='celabel' style={{fontSize: (breaking_point_mobile ? '' : '18px'), fontWeight: '700', color: 'white', position: 'absolute', marginTop: (breaking_point_desktop ? '-150px' : (breaking_point_mobile ? '-100px' : '-70px'))}}>Computer Engineering
                </h2>
                        ...
                        <div style={{display: 'flex', flexDirection: 'row'}}>
                            ...
                            {user_signed_in ? 
                                <button onClick={() => setUser_signed_in(false)} style={{width: '134px', color: '#6A6A6B', borderColor: '#6A6A6B'}} class="btn btn-sm" type="button">
                                    <span>
                                        <img style={{marginTop: '-2px'}} alt='->' src={leaveicon} />
                                    </span> 
                                    &nbsp; Leave Group
                                </button>: 
            ...
            <div className='wholeleft'>
                                ...
                                <>
                                    <div style={{display: 'flex'}}>
                                        ...
                                        <div style={{display: 'flex', flexDirection: 'column'}}>
                                            ...
                                            <p style={{fontSize: '15px', color: '#525252', marginTop: '-8px', marginBottom: '0px'}}>800 views</p>
                                        </div>
                                    </div>
                                    <div style={{display: 'flex'}}> 
                                        <button class="btn" style={{backgroundColor: '#EDEEF0'}} type="button">
                ...
                {breaking_point_desktop && <div className='wholeright'>
                    ...
                    <div class="input-group flex-nowrap">
                        <span style={{paddingLeft: '0px', paddingRight: '1px', borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderColor: '#B8B8B8', borderBottomLeftRadius: '0px', background: 'white'}} class="input-group-text" id="addon-wrapping"><img alt='location' src={locationicon} />
                        </span>
                    ...
                    <div style={{display: (!user_signed_in && 'none')}}>
                        ...
                        <br />
                        <h6>
                            <img style={{marginTop: '-5px'}} src={likeicon} alt=''/> RECOMMENDED GROUPS
                        </h6>
                        ...
                        {follow_groups.map((group) => <>
                            ...
                            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                                ...
                                <button onClick={() => Updating_follow_grp(group[1])} type="button" style={{backgroundColor: (group[2] ? 'black' : '#EDEEF0'), borderRadius: '21px', color: (group[2] ? 'white' : 'black'), width: (group[2] ? '100px' : '85px'), height: '30px', marginTop: '6px', paddingTop: '2px'}} class="btn">{group[2] ? 'Followed' : 'Follow'}
                                </button>
                            </div>
                            </>
                        )}
            ...
            <div class="modal fade" id="createaccountmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <button className='closebtn' style={{position: 'relative', backgroundColor: 'transparent', border: 'none', top: '80px'}} type="button" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal fade" id="signupmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <button className='closebtn' style={{position: 'relative', backgroundColor: 'transparent', border: 'none', top: '105px'}} type="button" data-bs-dismiss="modal" aria-label="Close"><img alt='close' src={modalcloseicon} /></button>
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div style={{borderRadius: '8px', border: 'none'}} class="modal-content">
                        <div style={{borderTopLeftRadius: '8px', borderTopRightRadius: '8px', border: 'none', backgroundColor: '#EFFFF4', color: '#008A45', fontSize: '15px'}} class="modal-header">
                            <h7 style={{margin: '0 auto'}} class="modal-title" id="exampleModalLabel">Let's learn, share & inspire each other with our passion for computer engineering. Sign up now 🤘🏼</h7>
                        ...
                        <div class="modal-body">
                            ...
                            <div style={{marginBottom: '5px', marginLeft: '10px', marginRight: '10px', display: 'flex', justifyContent: 'space-evenly'}}>
                                <div style={{width: '50%'}}>
                                    ...
                                    <input style={{height: '45px', borderTop: 'none', borderRadius: '0px', backgroundColor: '#F7F8FA'}} type="password" class="form-control" placeholder="Password" aria-describedby="addon-wrapping" />
                                    <button onClick={() => setUser_signed_in(true)} data-bs-dismiss="modal" style={{height: '45px', marginTop: '15px', borderRadius: '25px', width: '100%'}} type="button" class="btn btn-primary">Sign In</button>
                                    <br /><br />
                                    <button onClick={() => setUser_signed_in(true)} data-bs-dismiss="modal" style={{height: '40px', marginBottom: '5px', width: '100%', borderColor: '#D9D9DB'}} class="btn btn-sm" type="button">
                                    <img alt='fb sign up' src={fblogo} />
                                    </button>
            ...
            <div style={{borderRadius: '8px 8px 0px 0px', height: '500px'}} class="offcanvas offcanvas-bottom" tabindex="-1" id="createaccountcanvas" aria-labelledby="offcanvasBottomLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        ...
                        <p data-bs-toggle="offcanvas" data-bs-target="#signupcanvas" style={{color: '#495057', textDecoration:'underline', cursor: 'pointer', marginTop: '25px', marginBottom: '5px'}}>or, Sign In</p>
                    ...
                    <p style={{fontSize: '12px', textAlign: 'center', margin: '0px 40px 0px 40px'}}>By signing up, you agree to our Terms & conditions, Privacy policy
                    </p>
                </div>
            </div>

            <div style={{borderRadius: '8px 8px 0px 0px', height: '500px'}} class="offcanvas offcanvas-bottom" id="signupcanvas" aria-labelledby="offcanvasBottomLabel">
                <div class="offcanvas-header">
                ...
                <div class="offcanvas-body">
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        ...
                        <p data-bs-toggle="offcanvas" data-bs-target="#createaccountcanvas"  style={{color: '#495057', textDecoration:'underline', cursor: 'pointer', marginTop: '25px', marginBottom: '5px'}}>or, Create Account</p>
